        ...
        <div className="pb-16 flex flex-col items-center w-full">
          ...
          <div className="flex flex-row items-center gap-6 sm:gap-12">
            <div className="flex flex-col items-center gap-2">
              <div className="relative">
                <GradientStar percentage={100} score={avgScore} sizeClass="size-20 sm:size-28" isNA={isNAState} customGradientStops={customGradientStops} starColor={isNAState ? '#647280' : dominantColor} onStarClick={() => exportElement(footerRef, 'Main-Rank')} />
              </div>
